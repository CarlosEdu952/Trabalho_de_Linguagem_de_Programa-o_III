...
$stmtCheck = $conexao->prepare("SELECT id FROM cadastro WHERE emailcelularcpf = ?");
$stmtCheck->bind_param("s", $emailcelular);
$stmtCheck->execute();
$stmtCheck->store_result();

if ($stmtCheck->num_rows > 0) {
    $mensagem = "<p class='erro'>Este e-mail, celular ou CPF já está cadastrado.</p>";
    $erro = true;
}
